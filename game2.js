...
class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Audio
        this.bgMusic = this.sound.add(this.audioKeys.bgMusicKey, { volume: 0.3, loop:true });
        this.catchSound = this.sound.add(this.audioKeys.catchKey, { volume:0.5 });
        this.bgMusic.play(); // safe now on user gesture
